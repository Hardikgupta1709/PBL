...
def validate_low_winrate_strategy(ticker_y, ticker_x, 
    ...
    if profit_factor > 1.5:
        ...
        print(f"    MARGINAL: Barely profitable")
        pf_score = 50
    else:
    ...
    if max_consec_losses < 10:
        ...
        print(f"    MODERATE: Watch for long losing streaks")
        streak_score = 70
    else:
    ...
    if n_blocks < 4:
        print(" Not enough data for block bootstrap")
        block_score = 50
    else:
        block_returns = []
        ...
        if p_value/2 < 0.05 and block_returns.mean() > 0:
            ...
            print(f"    MARGINAL: Some evidence of edge")
            block_score = 60
        else:
    ...
    # Check if NORMAL regime is profitable 
    ...
    if len(normal_trades) > 0:
        ...
        print(f"\n    WARNING: No trades in NORMAL regime")
        regime_score = 50
    ...
    if overall >= 80 and critical_pass:
        ...
        print("\n  valid mean-reversion strategy with:")
