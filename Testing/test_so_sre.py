"""
Quick Test: SO vs SRE with Full Validation
Uses the test_discovered_pairs.py framework
"""
...
# SO vs SRE configuration (from your TOP_PAIRS list)
ticker_y = 'SO'
ticker_x = 'SRE'
score = 85
...
try:
    ...
    if positive_returns >= 0.75:
        ...
        print(f"   ⚠️ MARGINAL ({positive_returns*100:.0f}% positive)")
...
try:
    ...
    if tc:
        ...
        if retention > 0.7:
            ...
            print(f"   ⚠️ MARGINAL (retains {retention*100:.1f}%)")
...
if overall >= 80 and scores['Monte Carlo'] >= 80:
    ...
    print("\n⚠️ MARGINAL - Shows promise but needs work")
    print("\nOptions:")
