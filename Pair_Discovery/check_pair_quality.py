...
def check_pair_quality(ticker_y, ticker_x, start_date='2018-01-01', end_date='2024-01-01'):
    ...
    try:
        ...
        if coint_pvalue < 0.01:
            ...
            print(" WEAK: Marginal cointegration (p < 0.10)")
            coint_score = 15
        else:
    ...
    try:
        ...
        if adf_pvalue < 0.01:
            ...
            print(" WEAK: Spread shows some stationarity (p < 0.10)")
            adf_score = 8
        else:
    ...
    try:
        ...
        if theta < 0:
            ...
            if 5 <= half_life <= 30:
                ...
                print(" TOO FAST: Spread reverts too quickly")
                print("   May be mostly noise, hard to capture")
                hl_score = 5
            else:
                print(" TOO SLOW: Takes too long to revert")
    ...
    if corr_std < 0.10 and corr_min > 0.50:
        ...
        print("UNSTABLE: Correlation changes significantly")
    ...
    if normalized_score >= 70:
        print("\n EXCELLENT PAIR - Highly Suitable ")
        print("\nThis pair shows:")
        ...
        print("\nMARGINAL PAIR - Not Ideal for Pairs Trading")
        print("\nIssues detected:")
        ...
        print("\n DO NOT TRADE THIS PAIR")
        print("   Strategy will likely fail validation")
    
    if normalized_score < 70:
        print("\n Try Finding Other pairs")
...
def suggest_parameters(score, results):
    ...
    if score >= 70:
        ...
        print("\n Moderate Quality Pair - Use Conservative Parameters:")
